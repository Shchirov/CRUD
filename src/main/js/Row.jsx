...
export class Row extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = { edit: this.props.id < 0, changed: this.props.id < 0 };
        this.textarea = null;
    ...
    render() {
        if (!this.state.edit) {
            ...
            this.textarea = <input className="row-edit" placeholder="Enter text" type="text" onBlur={this.save.bind(this)} defaultValue={this.props.text} ref="input" />;
        }
        let classValue = "row";
        if (this.state.changed)
            classValue += " changed";
        return (
            <div className={classValue} onClick={this.edit.bind(this)}>
                {this.textarea}
